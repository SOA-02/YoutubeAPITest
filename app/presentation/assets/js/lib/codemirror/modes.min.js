  ...
  (function (e) {
    ...
    e.defineMode("sass", function (e) {
      ...
      function l(e, t) {
        var c = e.peek();
        if (e.match("/*"))
          return (t.tokenizer = n(e.indentation(), !0)), t.tokenizer(e, t);
        if (e.match("//"))
          return (t.tokenizer = n(e.indentation(), !1)), t.tokenizer(e, t);
  ...
  (function (e) {
    ...
    function n(e, t) {
      if ((e.backUp(1), e.match(/(R|u8R|uR|UR|LR)/))) {
        ...
        return r
          ? ((t.cpp11RawStringDelim = r[1]), (t.tokenize = o), o(e, t))
          : !1;
      }
    ...
    function a(t, r) {
      ...
      n(r.keywords),
        ...
        n(r.atoms),
        i.length &&
          ((r.helperType = t[0]), e.registerHelper("hintWords", t[0], i));
        ...
        token: function (e, t) {
          ...
          if (
            ...
            if ("{" == c) s(t, e.column(), "}");
              ...
              for ("}" == r.type && (r = l(t)); "statement" == r.type; )
                r = l(t);
            } else
              c == r.type
                ? l(t)
  ...
  (function (e) {
    ...
    e.defineMode("javascript", function (t, r) {
      ...
      function o(e, t) {
        ...
        if (Ce.test(r))
          return e.eatWhile(Ce), i("operator", "operator", e.current());
        if (we.test(r)) {
          e.eatWhile(we);
          var o = e.current(),
                    ...
                    : "function" == e
                      ...
                      : "for" == e
                        ...
                        : "variable" == e
                          ? h(b("stat"), I)
                          : "switch" == e
                            ? h(b("form"), w, b("}", "switch"), x("{"), F, y, y)
                            : "case" == e
                              ? h(w, x(":"))
                              : "default" == e
                                ? h(x(":"))
                                : "catch" == e
                                  ? h(b("form"), g, x("("), te, x(")"), k, y, v)
                                  : "module" == e
                                    ? h(b("form"), g, ae, v, y)
                                    : "class" == e
                                      ? h(b("form"), re, y)
    ...
    e.defineMode("coffeescript", function (e, t) {
      ...
      function i(e, r, i) {
        return function (o, a) {
          ...
          return (
            r && (t.singleLineStringErrors ? (i = c) : (a.tokenize = n)), i
          );
        };
      }
      function o(e, t) {
    ...
    e.defineMode("nginx", function (e) {
      ...
      return {
        ...
        indent: function (e, t) {
          ...
          return (
            /^\}/.test(t) &&
              (r -= "rule" == e.stack[e.stack.length - 1] ? 2 : 1),
            e.baseIndent + r * d
          );
        },
        electricChars: "}",
    ...
    e.defineMode("ruby", function (e) {
      ...
      function n(e, t) {
        ...
        if ("0" == i)
          return (
            e.eatWhile(
              e.eat("x") ? /[\da-fA-F]/ : e.eat("b") ? /[01]/ : /[0-7]/,
            ),
            "number"
          );
        if (/\d/.test(i))
        ...
        return (
          ...
          function (t, r) {
            if ("}" == t.peek()) {
              ...
              "{" == t.peek() && (r.tokenize[r.tokenize.length - 1] = i(e + 1));
            return n(t, r);
          }
        );
      }
          ...
          return {
            ...
            copyState: function (t) {
              ...
              return (
                ...
                n &&
                  (n = { mode: n.mode, local: e.copyState(n.mode, n.local) }),
      ...
      function (t) {
        ...
        return {
          ...
          copyState: function (t) {
            ...
            return (
              t.localState &&
                (r = e.copyState(o != u.html ? i : n, t.localState)),
              {
                token: t.token,
                tokenize: t.tokenize,
                localMode: t.localMode,
    ...
    e.defineMode("velocity", function () {
      ...
      function r(e, r) {
        ...
        if ('"' != d) {
          ...
          if (c.test(d))
            return (r.lastTokenWasBuiltin = !1), e.eatWhile(c), "operator";
          e.eatWhile(/[\w\$_{}@]/);
          var f = e.current();
      ...
      return {
        token: function (e, r) {
          ...
          if (r.pairStart) {
            ...
            if (0 == r.inlinePairs && e.match(/^\s*-?[0-9\.\,]+\s?$/))
              return "number";
                    ...
                    : "catch" === a && (i = _(r, ["try"]))
                      ...
                      : c(a, ["end", "after", "of"])
                        ...
                        : c(a, A)
                          ...
                          : c(s.token, [",", "|", "||"]) ||
                              c(a, [",", "|", "||"])
                            ? ((i = k(r)), i ? i.column + i.token.length : o)
                            : "->" == s.token
                              ? c(l.token, ["receive", "case", "if", "try"])
                                ? l.column + o + o
                                : l.column + o
                              : c(s.token, P)
                                ? s.column + s.token.length
                                : ((i = w(r)), S(i) ? i.column + o : 0)
              : 0;
        }
        function x(e) {
          var t = e.match(/,|[a-z]+|\}|\]|\)|>>|\|+|\(/);
      ...
      function n(e, t) {
        if (
          ...
          if (t.javaScriptLineExcludesColon && ":" === e.peek())
            return (
              (t.javaScriptLine = !1), void (t.javaScriptLineExcludesColon = !1)
            );
          ...
          if (t.inAttributeName && e.match(/^[^=,\)!]+/))
            return (
              ("=" === e.peek() || "!" === e.peek()) &&
                ...
                "script" === t.lastTag &&
                "type" === e.current().trim().toLowerCase()
                  ? (t.attributeIsType = !0)
                  : (t.attributeIsType = !1)),
              "attribute"
            );
