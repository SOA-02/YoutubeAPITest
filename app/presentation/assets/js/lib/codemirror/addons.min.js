...
!(function (e) {
  ...
  (function (e) {
      ...
      if (
        ...
        t.global || (t = new RegExp(t.source, t.ignoreCase ? "ig" : "g")),
          (this.matches = function (i, r) {
            ...
            return n && d
              ? { from: o(r.line, a), to: o(r.line, a + d), match: n }
              : void 0;
          });
      else {
        var a = t;
        ...
        if (1 == l.length)
            ...
            ? (this.matches = function (r, n) {
                if (r) {
                  ...
                  if (d > -1)
                    return (
                      (d = i(l, c, d)),
                      { from: o(n.line, d), to: o(n.line, d + a.length) }
                    );
                } else {
          ...
          this.matches = function (t, i) {
            ...
            if (t) {
              ...
              if (s(e.getLine(i.line).slice(0, c[r].length)) != l[l.length - 1])
                return;
              for (
                var n = o(i.line, c[r].length), a = i.line - 1, d = r - 1;
                d >= 1;
                --d, --a
              )
            ...
            if (!(i.line + (l.length - 1) > e.lastLine())) {
              ...
              if (s(h.slice(u)) == l[0]) {
                for (
                  ...
                  if (l[d] != s(e.getLine(a))) return;
                if (s(e.getLine(a).slice(0, c[r].length)) == l[r])
    ...
    (t.prototype = {
      ...
      find: function (e) {
        function t(e) {
          var t = o(e, 0);
          return (i.pos = { from: t, to: t }), (i.atOccurrence = !1), !1;
        }
        for (
          var i = this, r = this.doc.clipPos(e ? this.pos.from : this.pos.to);
          ;
      ...
      e.defineExtension("selectMatches", function (t, i) {
        for (
          var o, r = [], n = this.getSearchCursor(t, this.getCursor("from"), i);
          (o = n.findNext()) && !(e.cmpPos(n.to(), this.getCursor("to")) > 0);
            ...
            e.operation(function () {
              o &&
                ...
                e.showMatchesOnScrollbar &&
                  ...
                  (n.annotate = e.showMatchesOnScrollbar(n.query, r(n.query)))),
        ...
        if (t.display.barWidth)
          for (var n, a = 0; a < r.length; a++) {
            for (
              ...
              (s = r[++a]), (c = t.charCoords(s.to, "local").bottom * i);
            if (c != l) {
  ...
  (function (e) {
    ...
    (t.prototype.findMatches = function () {
      ...
      (t.prototype.onChange = function (t) {
        ...
        if (
          (this.gap
            ? ((this.gap.from = Math.min(i(this.gap.from, o, n), t.from.line)),
              (this.gap.to = Math.max(i(this.gap.to, o, n), t.from.line)))
  ...
  (function (e) {
    ...
    function i(e) {
      ...
      (i.style.cssText = "height: 0; overflow: visible"),
        ...
        i.appendChild(document.createTextNode(e.getOption("placeholder"))),
        e.display.lineSpace.insertBefore(i, e.display.lineSpace.firstChild);
    }
    function o(e) {
      n(e) && i(e);
    }
  ...
  (function (e) {
    ...
    function i(t, i) {
      for (
        ...
        if (
          ...
          return e.Pass;
        if ("xml" != d.mode.name)
          if ("htmlmixed" == t.getMode().name && "javascript" == d.mode.name)
            r[s] = a + "script>";
          else {
            if ("htmlmixed" != t.getMode().name || "css" != d.mode.name)
              return e.Pass;
            r[s] = a + "style>";
          }
        else {
          if (!h.context || !h.context.tagName || n(t, h.context.tagName, l, h))
            return e.Pass;
    ...
    function n(t, i, o, r, n) {
      ...
      for (var l = r.context, c = n ? 1 : 0; l && l.tagName == i; l = l.prev)
        ++c;
      o = s.to;
      for (var d = 1; c > d; d++) {
    ...
    function c(e) {
      ...
      if (t) {
        ...
        clearTimeout(t.changeUpdate),
          (t.changeUpdate = setTimeout(function () {
            var i = e.getViewport();
            t.from == t.to || i.from - t.to > 20 || t.from - i.to > 20
              ? a(e)
              : e.operation(function () {
  ...
  (function (e) {
    ...
    e.registerHelper("fold", "indent", function (t, i) {
      ...
      if (/\S/.test(r)) {
        ...
        return s
          ? { from: e.Pos(i.line, r.length), to: e.Pos(s, t.getLine(s).length) }
          : void 0;
      }
    });
  }),
    ...
    e.registerHelper("fold", "brace", function (t, i) {
      ...
      e.registerHelper("fold", "import", function (t, i) {
        function o(i) {
          ...
          if (
            (/\S/.test(o.string) || (o = t.getTokenAt(e.Pos(i, o.end + 1))),
          ...
          for (var r = i, n = Math.min(t.lastLine(), i + 10); n >= r; ++r) {
            var a = t.getLine(r),
              s = a.indexOf(";");
            if (-1 != s) return { startCh: o.end, end: e.Pos(r, s) };
          }
        }
        var r,
          i = i.line,
      ...
      for (var i = []; ; ) {
        ...
        if ("selfClose" != o)
          if (r[1]) {
            ...
            if (0 > c && (!t || t == r[2]))
              return { tag: r[2], from: u(n, s), to: u(e.line, e.ch) };
          } else i.push(r[2]);
      }
    }
    function h(e, t) {
      for (var i = []; ; ) {
        ...
        if ("selfClose" != o) {
          ...
          if (a[1]) i.push(a[2]);
            ...
            if (0 > l && (!t || t == a[2]))
              return { tag: a[2], from: u(e.line, e.ch), to: u(r, n) };
          }
        } else s(e);
      }
    }
  ...
  (function (e) {
    ...
    e.defineOption("styleActiveLine", !1, function (i, n, a) {
      ...
      n && !s
        ...
        : !n &&
          s &&
          (i.off("beforeSelectionChange", r), t(i), delete i.state.activeLines);
    });
  }),
  (function (e) {
    "object" == typeof exports && "object" == typeof module
            ...
            (n["'" + t + "'"] = function (n) {
              ...
              for (var s, d, h = n.listSelections(), u = 0; u < h.length; u++) {
                ...
                if (g.empty())
                  if (t == o && d == o)
                    f =
                      n.getRange(p, c(p.line, p.ch + 3)) == t + t + t
                        ? "skipThree"
                        : "skip";
                  else if (
                    t == o &&
                    p.ch > 1 &&
                    r.indexOf(t) >= 0 &&
                    n.getRange(c(p.line, p.ch - 2), p) == t + t &&
                    (p.ch <= 2 ||
                      n.getRange(c(p.line, p.ch - 3), c(p.line, p.ch - 2)) != t)
                  )
                    f = "addFour";
                  else if ('"' == t || "'" == t) {
              ...
              n.operation(function () {
                if ("skip" == s) n.execCommand("goCharRight");
                  ...
                  for (var i = n.getSelections(), e = 0; e < i.length; e++)
                    i[e] = t + i[e] + o;
                  ...
                  "both" == s
                    ...
                    : "addFour" == s &&
                      (n.replaceSelection(t + t + t + t, "before"),
            ...
            t != o &&
              (n["'" + o + "'"] = function (t) {
                for (var i = t.listSelections(), r = 0; r < i.length; r++) {
                  ...
                  if (
                    !n.empty() ||
                    t.getRange(n.head, c(n.head.line, n.head.ch + 1)) != o
                  )
                    return e.Pass;
                }
  ...
  (function (e) {
    ...
    function o(e) {
      e.operation(function () {
        var t = e.state.matchHighlighter;
        if (
          (t.overlay && (e.removeOverlay(t.overlay), (t.overlay = null)),
          ...
          return void (
            l > s && e.addOverlay((t.overlay = a(n.slice(s, l), i, t.style)))
          );
        }
      ...
      return {
        token: function (o) {
          return !o.match(e) || (t && !n(o, t))
            ? (o.next(), void (o.skipTo(e.charAt(0)) || o.skipToEnd()))
            : i;
        },
      };
    }
